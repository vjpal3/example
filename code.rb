...
people["Dr. Adela DuBuque"]["children"][0] = "Tomas"
puts people.inspect
puts ""
...
sets_of_people[0].each do |person, data|
  if data["company"].downcase.include?("m")
    puts person
  end
end
